...
def print_words(filename):
    """
    contra a frequencia de palavras de um arquivo e imprime as palavras em ordem alfabetica, com sua frequencia.
    """
    d = {}
...
def print_top(filename):
    """
    contra a frequencia de palavras de um arquivo e imprime as 20 palavras mais frequentes em ordem decrescente de frequencia.
    """
    d = {}
    with open(filename, 'r') as f:
        for line in f:
